...
export default function HowItWorks() {
  return (
    <section aria-labelledby="how-it-works-heading" className="mx-auto max-w-6xl py-16 px-4" style={{ backgroundColor: '#f0f0f0' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: 'repeat(3, 1fr)', gap: '16px' }}>
        {/* Row 1 */}
        ...
        <div style={{ border: '5px solid #f86406', minHeight: '250px', padding: '20px' }}>
          <img src="/How it works imagery/website.png" alt="Website" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
        </div>
        
        {/* Row 2 */}
        <div style={{ border: '5px solid #f86406', minHeight: '250px', padding: '20px' }}>
          <img src="/How it works imagery/growth.png" alt="Growth" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
        </div>
        <div style={{ border: '2px solid black', minHeight: '250px', padding: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ textAlign: 'left' }}>
        ...
        <div style={{ border: '5px solid #f86406', minHeight: '250px', padding: '20px' }}>
          <img src="/How it works imagery/care.png" alt="Care" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
        </div>
      </div>
    </section>
  );
